...
Active: Reduces attack speed of nearby enemies by 65% for 5 seconds in a 4-meter range. Does not reduce below the base attack speed animation. (15s cooldown)"""
  ...
  test("Get items", () async {
    var req = app.client.clientAuthenticatedRequest("/admin/items");
  ...
  test("Get item", () async {
    var req = app.client.clientAuthenticatedRequest("/admin/items/1");
    var response = await req.get();
  ...
  test("Update Item", () async {
    var req = app.client.clientAuthenticatedRequest("/admin/items/2")
      ..json = {
  ...
  test("Delete Item", () async {
    var deleteReq = app.client.clientAuthenticatedRequest("/admin/items/1");
  ...
  test("prevents unauthorized access", () async {
    var req = app.client.request("/admin/items");
    var response = await req.get();
