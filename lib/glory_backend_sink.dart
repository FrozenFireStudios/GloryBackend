...
///
/// See the documentation in this file for [initializeApplication], [GloryBackendSink], [setupRouter] and [willOpen]
...
/// for more details.
class GloryBackendSink extends RequestSink {
  ...
  static Future initializeApplication(ApplicationConfiguration config) async {
    ...
    var configFileValues =
        new GloryBackendConfiguration(config.configurationFilePath);
  ...
  GloryBackendSink(ApplicationConfiguration options) : super(options) {
...
class GloryBackendConfiguration extends ConfigurationItem {
  GloryBackendConfiguration(String fileName) : super.fromFile(fileName);
